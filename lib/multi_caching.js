 ...
 * @param {boolean} [options.safeClone] - FILLME
 */
var multiCaching = function(caches, options) {
    ...
    if (typeof options.safeClone !== 'boolean') {
        options.safeClone = false;
    }
    var callbackFiller = new CallbackFiller({clone: options.safeClone});
